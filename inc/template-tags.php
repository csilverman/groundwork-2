...
if ( ! function_exists( 'groundwork_2_posted_on' ) ) :
	/**
...
if ( ! function_exists( 'groundwork_2_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'groundwork_2_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function groundwork_2_entry_footer() {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'groundwork-2' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'groundwork-2' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'groundwork_2_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function groundwork_2_post_thumbnail() {
